param(
    ...
    [ValidateSet('correction','continuation','capture_history','countermove','singular','verified_null','probcut','dynamic_lmr','history_pruning','see_pruning','mate_distance','iid','tt_policy','time_management','strategic_eval','king_safety','search_safety','pawn_cache','lazy_smp','rfp','version','trend_safety','calibrated_lmr','adaptive_time','reuse_move_facts','legal_fast_path')]
